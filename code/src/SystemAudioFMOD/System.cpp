...
System::Type FMODSystem::GetSystemType(void)
{
...
Error FMODSystem::Initialize(Properties::Array Properties)
{
	//
...
void FMODSystem::GetProperties(Properties::Array& Properties)
{
	//
...
void FMODSystem::SetProperties(Properties::Array Properties)
{
...
ISystemScene* FMODSystem::CreateScene(void)
{
...
Error FMODSystem::DestroyScene(ISystemScene* pSystemScene)
{
...
void FMODSystem::SetCPUUsage(f32 CPU)
{
	m_CPUStat = CPU;
}
...
f32 FMODSystem::GetCPUUsage(void)
{
	return m_CPUStat;
}
...
void FMODSystem::ResumeAll(void) 
{
	music->setPaused( false );
	statePlaying->setPaused( false );
}
...
void FMODSystem::MuteMusic(void) 
{
	music->setPaused( true );
}
...
void FMODSystem::UnmuteMusic(void) 
{
	music->setPaused( false );
}
...
bool FMODSystem::AudioInitialized(void) 
{
...
void FMODSystem::FMODErrorCode(i32 FMODresult, pstr file)
{
