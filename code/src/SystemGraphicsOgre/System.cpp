...
void OGREGraphicsSystem::windowClosed(Ogre::RenderWindow* pRenderWindow)
{
...
pcstr OGREGraphicsSystem::GetName(void)
{
	return System::Names::Graphics;
}


System::Type OGREGraphicsSystem::GetSystemType(void)
{
	return System::Types::Graphics;
}


Error OGREGraphicsSystem::Initialize(Properties::Array Properties)
{
...
void OGREGraphicsSystem::GetProperties(Properties::Array& Properties)
{
	//
...
void OGREGraphicsSystem::SetProperties(Properties::Array Properties)
{
	ASSERT( m_bInitialized );
...
ISystemScene* OGREGraphicsSystem::CreateScene(void)
{
	return new OGREGraphicsScene( this );
}


Error OGREGraphicsSystem::DestroyScene(ISystemScene* pSystemScene)
{
