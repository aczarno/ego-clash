...
#include "AIs\Horse.h"
#include "AIs\Swallow.h"
#include "CamBot.h"
#include "POI.h"

#include "../Framework/IttNotify.h"

__ITT_DEFINE_STATIC_EVENT(g_tpeChangeOccurred, "AI Scene: ChangeOccurred", 24 );
__ITT_DEFINE_STATIC_EVENT(g_tpeProcessRange, "AI Scene: Process Range", 23 );
...
{
    __ITT_EVENT_START(g_tpeChangeOccurred);
    ...
    __ITT_EVENT_END(g_tpeChangeOccurred);
    return Errors::Success;
}
...
{
    __ITT_EVENT_START(g_tpeProcessRange);
    ...
    __ITT_EVENT_END(g_tpeProcessRange);
}
